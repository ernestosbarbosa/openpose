...
upload_dir = "/home/ernesto/Documentos/upload/"
completed_dir = "/home/ernesto/Documentos/completed/"
    ...
    while 1:
        ...
        while(cap.isOpened()):
            ...
            if ret == True:
                ...
                # resp = keypoints.tolist()
                # repl1 = resp.replace(".", "0")
                # repl2 = repl1.replace(", ]", ",0]")
                # repl3 = repl2.replace("[[[[", "[[[[\"")
                # points = repl1.replace(", ]", ",0]")
                # f.write(points)
                f.write(resp)
                f.write(",")
            else: 
